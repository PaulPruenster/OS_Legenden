...
void *write_to_server(void *arg)
{
    ...
    for (;;)
    {
        ...
        {
            printf("schaden\n");
            // TODO dor reader thread wert net gekillt nor wortet die main afn sem obwohl es recv eig fahler schmeisen sollet
            // TODO vlt oenfoch /quit senden und dor server soll in client beenden? sell hot dor oene im ps getun

            // TODO server sendent in folschen client es folsche zuig schunscht passts, client isch /quit hin und es unzoegen
            fflush(stdout);
            return NULL;
        }
